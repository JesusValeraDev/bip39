...
export const translations: Record<string, Translations> = {
  en: {
    ...
    infoText: 'Each box represents a bit. The 12 boxes create a number from 1-2048, which maps to one of the 2048 BIP39 words.',
  ...
  es: {
    ...
    infoText: 'Cada casilla representa un bit. Las 12 casillas crean un número de 1-2048, que corresponde a una de las 2048 palabras BIP39.',
  ...
  fr: {
    ...
    infoText: 'Chaque case représente un bit. Les 12 cases créent un nombre de 1-2048, qui correspond à l\'un des 2048 mots BIP39.',
  ...
  cs: {
    ...
    infoText: 'Každé pole představuje jeden bit. 12 polí vytvoří číslo od 0 do 2048, které odpovídá jednomu z 2048 slov BIP39.',
  ...
  it: {
    ...
    infoText: 'Ogni casella rappresenta un bit. Le 12 caselle creano un numero da 1-2048, che corrisponde a una delle 2048 parole BIP39.',
  ...
  pt: {
    ...
    infoText: 'Cada caixa representa um bit. As 12 caixas criam um número de 1-2048, que mapeia para uma das 2048 palavras BIP39.',
  ...
  ja: {
    ...
    infoText: '各ボックスは1ビットを表します。12個のボックスは1-2048の数値を作成し、2048個のBIP39単語の1つにマッピングされます。',
  ...
  ko: {
    ...
    infoText: '각 상자는 비트를 나타냅니다. 12개의 상자는 1-2048 범위의 숫자를 만들며, 2048개의 BIP39 단어 중 하나에 매핑됩니다.',
  ...
  'zh-Hans': {
    ...
    infoText: '每个方框代表一个位。12 个方框创建一个从 1-2048 的数字，对应 2048 个 BIP39 单词之一。',
  ...
  'zh-Hant': {
    ...
    infoText: '每個方框代表一個位。12 個方框創建一個從 1-2048 的數字，對應 2048 個 BIP39 單詞之一。',
